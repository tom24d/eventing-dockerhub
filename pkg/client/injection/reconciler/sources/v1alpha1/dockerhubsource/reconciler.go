...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.DockerHubSource, desired *v1alpha1.DockerHubSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.DockerHubSource, desiredFinalizers sets.String) (*v1alpha1.DockerHubSource, error) {
	// Don't modify the informers copy.
