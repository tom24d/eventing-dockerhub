...
import (
	...
	versionedscheme "github.com/tom24d/eventing-dockerhub/pkg/client/clientset/versioned/scheme"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := dockerhubsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.DockerHubSource"),
	)
